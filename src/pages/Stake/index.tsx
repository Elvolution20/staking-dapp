...
const Stake = () => {
  ...
  return (
    <div className="bg-purple-100 mx-auto max-w-lg shadow-lg dark:shadow-2xl rounded overflow-hidden p-4 sm:flex dark:bg-purple-800 mt-20">
      <form className="w-full p-5">
        <div className="mt-4">
          <div className="flex justify-between">
            ...
            >
              {interaction.data &&
                parseFloat(interaction.data.stakeBalance).toFixed(2)}{' '}
              Stake
            </label>
            <label
              className="block text-gray-700 text-sm font-bold mb-2 text-left dark:text-gray-50"
        ...
        <div className="flex justify-between mt-6">
          <button
            className={`bg-purple-400 py-4 px-6 rounded-lg text-gray-50 ${
          ...
          <button
            className={`bg-purple-300 py-4 px-8 rounded-lg text-gray-50 ${
