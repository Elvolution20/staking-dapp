...
const Navbar = () => {
  ...
  return (
    <>
      <header className="bg-purple-300 dark:bg-purple-800">
          ...
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2">
              {interaction.data !== null ? (
                ...
                <button
                  className="bg-purple-100 dark:bg-purple-50 dark:text-gray-800  py-1 px-3 text-sm rounded-md text-gray-600 hover:text-gray-800 dark:hover:text-black focus:outline-none"
